...
class RegulatoryAgent:
    ...
    def _load_regulations(self) -> Dict[str, Dict]:
        ...
        regulations = {}
        reg_path = Path("config/regulations")
    ...
    def _check_usa_faa(self, state: Dict[str, Any]) -> Dict:
        ...
        # Weight category
        if auw_kg < 0.25:
            compliance['category'] = 'Below 0.55 lb'
            compliance['notes'].append("No registration required")
        elif auw_lb <= 55:
            compliance['category'] = 'Part 107'
            compliance['requirements'].append("FAA Registration ($5)")
            compliance['requirements'].append("Part 107 Remote Pilot Certificate")
            compliance['requirements'].append("Remote ID compliance (required Sept 2023)")
        else:
            compliance['category'] = 'Over 55 lb'
